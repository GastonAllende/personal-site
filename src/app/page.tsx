      ...
      <main className="flex items-center w-full min-h-screen">
        <Layout className="pt-0">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="w-1/2">
              <h1 className="capitalize text-6xl font-bold">Turning Vision Into Reality With Code And Design.</h1>
              <p className="my-4 font-medium text-base">
                I am a passionate Frontend developer with a touch of backend and design skills. I have been working in
                the industry for over 10 years and I love what I do. Navigate the page and get to know me a little
                better.
              </p>
              <div className="flex items-center self-start mt-2">
                ...
                <Link
                  ...
                  href="mailto:gaston.saavedra@me.com"
                  target="_blank"
                >
                  Contact
                </Link>
