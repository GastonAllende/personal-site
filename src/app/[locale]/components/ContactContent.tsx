						...
						<AnimatePresence mode="wait">
							{submitted ? (
								<motion.div
									...
									className="bg-linear-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 p-8 md:p-12 rounded-3xl border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center gap-6 min-h-105"
								>
